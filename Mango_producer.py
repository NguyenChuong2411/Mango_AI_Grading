...
def produce_video(video_path, bootstrap_servers='localhost:9092', topic='video-stream', resize_factor=1.0, quality=95):
...
if __name__ == "__main__":
    video_path = "./5471316-hd_1920_1080_24fps.mp4"
    produce_video(video_path, resize_factor=1.0, quality=95)
